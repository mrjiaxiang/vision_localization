...
#include "vision_localization/filter/error_state_kalman_filter.hpp"
...
ErrorStateKalmanFilter::ErrorStateKalmanFilter(const Json::Value &node) {
    //
    // parse config:
    //
    // a. earth constants:
    ...
    COV.MEASUREMENT.POSE.ORI =
        node["covariance"]["measurement"]["pose"]["ori"].asDouble();
