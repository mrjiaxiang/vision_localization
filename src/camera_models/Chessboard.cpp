#include "vision_localization/camera_models/Chessboard.h"
...
#include "vision_localization/camera_models/ChessboardQuad.h"
#include "vision_localization/camera_models/Spline.h"
    ...
    for (int k = 0; k < 6; ++k) {
        for (int dilations = minDilations; dilations <= maxDilations;
            ...
            if (flags & CV_CALIB_CB_ADAPTIVE_THRESH) {
                ...
                // convert to binary
                cv::adaptiveThreshold(img, thresh_img, 255,
